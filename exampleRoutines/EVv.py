...
for runId in np.arange(nRuns):
    ...
    agent = srlagents.ReinforceEVBaseline(policyNets, valueNet, simulator, baseline_loss="var",
    ...
    with open(folderPrefix+'EV/'+envName+'EVvRewards_'+config_name+'_nRuns'+str(nRuns)+'_nEpochs'+str(nEpochs)+'_nTraj'+str(nTraj)+'_'+nameAppendix+'.pkl','wb') as f:
